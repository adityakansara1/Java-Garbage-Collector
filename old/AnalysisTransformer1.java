...
public class AnalysisTransformer extends SceneTransformer {
    ...
    protected void internalTransform(String arg0, Map<String, String> arg1) {
        ...
        // for (String objects : methodToGcLines.get(method)) {
    ...
    protected static void processCFG(SootMethod method) {
        ...
        for (Unit u : units) {
            ...
            // System.out.println(u + " " + u.getJavaSourceStartLineNumber());
            ...
            if (u instanceof JIdentityStmt) {
                ...
                if (left instanceof JimpleLocal && right instanceof JNewExpr) {
                    ...
                    // System.out.println("Assign StaticInvoke: " + methodSign);
                    // System.out.println("Assign StaticInvoke: " + currMethodSign);
                    HashMap<String, Set<Object>> methodStack = stack.get(methodSign);

                    if (methodStack.containsKey("ret")) {
                        // System.out.println("---------------------");
                    }
                    ...
                    // System.out.println("InvokeSTMT: " + methodSign);
                    // System.out.println("InvokeSTMT: " + currMethodSign);
                    HashMap<String, Set<Object>> methodStack = stack.get(methodSign);
                    Set<Object> retObjects = methodStack.get("ret");
                ...
                if (expr instanceof JStaticInvokeExpr) {
                    ...
                    // System.out.println("EXPR " + u + " " + u.getJavaSourceStartLineNumber());
                    ...
                    // System.out.println("Unknown InvokeStmt: " + u);
                }
            ...
            // System.out.println("KILLED: " + killed.toString());
            for (String k : killed) {
        ...
        for (String o : objectsPointedByParams) {
            // System.out.print("PARAM::::::: " + o);
        }
        // System.out.println();

        if (objectsPointedByRet != null) {
            for (String o : objectsPointedByRet) {
                // System.out.print("RET::::::::: " + o);
            }
            // System.out.println();
        } else {
            // System.out.println("RET::::::::: " + "EMPTY");
        }

        // System.out.println("LAST: " + body.getMethod());
    ...
    static void printHeap(Object o1) {
        ...
        for (Field f : o1.getFields()) {
            ...
            // System.out.println(o1.getName() + "\t" + "-" + f.getName() + "->" + "\t" +
            // o.getName());
            printHeap(o);
        }
    }
